...
module.exports = app => {
  ...
  // 评论列表
  // 查询货物评论列表
  router.get(apiPrefix + "/comment/list", controller.api.comment.list);
  // 查询货物评论总数
  router.get(apiPrefix + "/comment/count", controller.api.comment.count);
  // 添加评论
  router.post(
    apiPrefix + "/comment/post",
    needLogin,
    controller.api.comment.addPost
  );
  ...
  // 微信登录
  router.post(
    apiPrefix + "/auth/loginByWeixin",
    controller.api.auth.loginByWeChat
  );
  ...
  // 更新购物车商品总数
  router.post(
    apiPrefix + "/cart/update",
    needLogin,
    controller.api.cart.update
  );
  // 删除购物车
  router.post(
    apiPrefix + "/cart/delete",
    needLogin,
    controller.api.cart.delete
  );
  // 下单前检查
  router.get(
    apiPrefix + "/cart/checkout",
    needLogin,
    controller.api.cart.checkout
  );
  // 选中或者剔除购物车内的货物
  router.post(
    apiPrefix + "/cart/checked",
    needLogin,
    controller.api.cart.checked
  );
  ...
  // 地址列表
  router.get(
    apiPrefix + "/address/list",
    needLogin,
    controller.api.address.list
  );
  // 地址详情
  router.get(
    apiPrefix + "/address/detail",
    needLogin,
    controller.api.address.detail
  );
  // 保存地址
  router.post(
    apiPrefix + "/address/save",
    needLogin,
    controller.api.address.save
  );
  // 删除地址
  router.post(
    apiPrefix + "/address/delete",
    needLogin,
    controller.api.address.deleteAddress
  );

  // 收藏相关接口
  // 显示用户收藏的所有货物
  router.get(
    apiPrefix + "/collect/list",
    needLogin,
    controller.api.collect.list
  );
  // 用户添加或者删除收藏
  router.post(
    apiPrefix + "/collect/addordelete",
    needLogin,
    controller.api.collect.addOrDelete
  );
  ...
  // 订单详情
  router.get(apiPrefix + "/order/detail", controller.api.order.detail);
  // 提交订单
  router.post(apiPrefix + "/order/submit", controller.api.order.submit);
  // 取消订单
  router.get(
    apiPrefix + "/order/cancel",
    needLogin,
